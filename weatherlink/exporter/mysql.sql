...
CREATE TABLE `weather_calculated_summary` (
    ...
    `temperature_outside_low_timestamp` datetime null COMMENT 'The date and time that temperature_outside_low was recorded',
    `temperature_outside_high` decimal(4,1) NULL COMMENT 'The high outdoor temperature during the summary period in ºF',
    `temperature_outside_high_timestamp` datetime null COMMENT 'The date and time that temperature_outside_high was recorded',
    ...
    `humidity_outside_low_timestamp` datetime null COMMENT 'The date and time that humidity_outside_low was recorded',
    ...
    `humidity_outside_high_timestamp` datetime null COMMENT 'The date and time that humidity_outside_high was recorded',
    ...
    `barometric_pressure_low_timestamp` datetime null COMMENT 'The date and time that barometric_pressure_low was recorded',
    ...
    `barometric_pressure_high_timestamp` datetime null COMMENT 'The date and time that barometric_pressure_high was recorded',
    `wind_speed_average` decimal(6,2) unsigned NULL COMMENT 'The average wind speed during the summary period in miles per hour',
    ...
    `wind_speed_high_direction` enum('N', 'NNE', 'NE', 'ENE', 'E', 'ESE', 'SE', 'SSE', 'S', 'SSW', 'SW', 'WSW', 'W', 'WNW', 'NW', 'NNW') NULL COMMENT 'The high (gust) wind speed direction',
    `wind_speed_high_timestamp` datetime null COMMENT 'The date and time that wind_speed_high was recorded',
    `wind_speed_high_10_minute_average` decimal(6,2) unsigned NULL COMMENT 'The high (average) wind speed during the summary period in miles per hour',
    ...
    `wind_speed_high_10_minute_average_start` datetime null COMMENT 'The date and time at which the high average wind speed period started',
    `wind_speed_high_10_minute_average_end` time null COMMENT 'The time on the same day at which the high average wind speed period ended',
    ...
    `wind_run_distance_daily_average` decimal(10,2) unsigned NULL COMMENT 'The average daily total distance traversed by the wind during the summary period bigger than daily',
    `wind_run_distance_weekly_average` decimal(10,2) unsigned NULL COMMENT 'The average weekly total distance traversed by the wind during only yearly and all-time summary periods',
    `wind_run_distance_monthly_average` decimal(10,2) unsigned NULL COMMENT 'The average monthly total distance traversed by the wind during only yearly and all-time summary periods',
    ...
    `rain_rate_high_timestamp` datetime null COMMENT 'The date and time that rain_rate_high was recorded',
    `solar_radiation_average` decimal(5,1) unsigned NULL COMMENT 'The average solar radiation during the summary period in watts per square meter',
    ...
    `solar_radiation_high_timestamp` datetime null COMMENT 'The date and time that solar_radiation_high was recorded',
    ...
    `uv_index_high_timestamp` datetime null COMMENT 'The date and time that uv_index_high was recorded',
    ...
    `temperature_wet_bulb_low_timestamp` datetime null COMMENT 'The date and time that temperature_wet_bulb_low was recorded',
    `temperature_wet_bulb_high` decimal(4,1) NULL COMMENT 'The high outdoor wet bulb temperature during the summary period in ºF',
    `temperature_wet_bulb_high_timestamp` datetime null COMMENT 'The date and time that temperature_wet_bulb_high was recorded',
    ...
    `dew_point_outside_low_timestamp` datetime null COMMENT 'The date and time that dew_point_outside_low was recorded',
    `dew_point_outside_high` decimal(4,1) NULL COMMENT 'The high outdoor dew point temperature during the summary period in ºF',
    `dew_point_outside_high_timestamp` datetime null COMMENT 'The date and time that dew_point_outside_high was recorded',
    ...
    `heat_index_outside_high_timestamp` datetime null COMMENT 'The date and time that heat_index_outside_high was recorded',
    ...
    `wind_chill_low_timestamp` datetime null COMMENT 'The date and time that wind_chill_low was recorded',
    ...
    `thw_index_low_timestamp` datetime null COMMENT 'The date and time that thw_index_low was recorded',
    ...
    `thw_index_high_timestamp` datetime null COMMENT 'The date and time that thw_index_high was recorded',
